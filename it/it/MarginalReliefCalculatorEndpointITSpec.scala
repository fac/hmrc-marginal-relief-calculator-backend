...
class MarginalReliefCalculatorEndpointITSpec
  ...
  "calculate endpoint" should {
    "return calculation result when given parameters are valid" in {
      ...
      response.body shouldBe """{"type":"SingleResult","details":{"type":"MarginalRate","taxRateBeforeMR":25,"corporationTaxBeforeMR":15000,"adjustedDistributions":0,"adjustedAugmentedProfit":60000,"taxRate":20.25,"year":2023,"adjustedUpperThreshold":250000,"fyRatio":{"numerator":366,"denominator":366},"marginalRelief":2850,"adjustedLowerThreshold":50000,"corporationTax":12150,"adjustedProfit":60000,"days":366},"effectiveTaxRate":20.25}""".stripMargin
    }
